  ...
  return (
    <section className="max-w-6xl mx-auto px-6 py-20">
      <div className="mb-12">
        ...
        <p className="text-teal-400 max-w-2xl">
      ...
      <div className="grid md:grid-cols-2 gap-12 items-start">
        {/* Left Content */}
        <div className="space-y-6 text-teal-300 leading-relaxed">
          <p className="text-teal-300 leading-relaxed max-w-3xl">
            I am a passionate{" "}
          ...
          <p className="text-teal-300 leading-relaxed max-w-3xl mt-6">
        ...
        {/* Right Card */}
        <div className="bg-teal-800/60 backdrop-blur rounded-2xl p-8 shadow-lg">
          <h2 className="text-xl font-semibold mb-6">Quick Facts</h2>

          <ul className="space-y-4 text-teal-300">
            <li className="flex justify-between">
              <span className="text-teal-400">Name</span>
              <span className="text-white">Umair Mansuri</span>
            </li>
            <li className="flex justify-between">
